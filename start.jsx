...
{
    // 创建主窗叿
    var dialog = new Window("dialog", "视?制作配罿系统");
    ...
    var folderLabel = folderGroup.add("statictext", undefined, "素材文件夹路徿:");
    ...
    var folderButton = folderPathGroup.add("button", undefined, "浏迿");
    ...
    var aepLabel = aepGroup.add("statictext", undefined, "AEP模板文件跿徿:");
    ...
    var aepButton = aepPathGroup.add("button", undefined, "浏迿");
    ...
    var artistLabel = artistGroup.add("statictext", undefined, "艺术家名秿:");
    ...
    var versionLabel = versionGroup.add("statictext", undefined, "剿标?名秿:");
    ...
    var normalColorLabel = textStyleRow2.add("statictext", undefined, "晿通?色(16进制RGB倿):");
    ...
    var highlightColorLabel = textStyleRow2.add("statictext", undefined, "高亮颜色(16进制RGB倿):");
    ...
    var lineSpacingLabel = layoutRow1.add("statictext", undefined, "行间跿:");
    ...
    var paraSpacingLabel = layoutRow1.add("statictext", undefined, "段间跿:");
    ...
    var initialOffsetLabel = layoutRow1.add("statictext", undefined, "初忋偏秿:");
    ...
    highlightScaleText.helpTip = "百分毿";
    ...
    var runButton = buttonGroup.add("button", undefined, "运迌主程序");
    ...
    folderButton.onClick = function() {
        var selectedFolder = Folder.selectDialog("选择素材文件夿");
        if (selectedFolder) {
    ...
    function createDirectoryStructure(baseFolderPath, num) {
        try {
            ...
            alert("盿录结构创建成功！\n圿 " + baseFolderPath + " 丿创建亿 " + num + " 丿素材绿");

        } catch (e) {
            alert("创建盿录时出现错迿＿" + e.toString());
        }
    }
    ...
    function generateConfigContent() {
        ...
        content += '    \n';
        content += '    // aep模板文件跿径，必填\n';
        content += '    AEP_PATH: "' + aepText.text + '",\n';
        content += '    \n';
        content += '    // 艺术家名称，塿写后覆盖WAV 音乐文件名的艺术家，叿不填\n';
        ...
        content += '            INITIAL_OFFSET: ' + parseFloat(initialOffsetText.text) + ' // 初忋偏移\n';
        content += '        },\n';
        content += '        \n';
        content += '        // 动画设置\n';
        content += '        ANIMATION: {\n';
        content += '            DURATION: ' + parseFloat(durationText.text) + ', // 动画持续时间（習）\n';
        ...
        content += '            FADE_OUT_DELAY: ' + parseFloat(fadeDelayText.text) + ' // 淡出延迟（習）\n';
        content += '        }\n';
        content += '    }\n';
        content += '};\n\n';
        content += '// ==================== 配置区域结束 ====================';
